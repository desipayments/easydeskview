...
class EasydeskviewImpl implements Easydeskview {
  final EasydeskviewPlatform _platform;
  factory EasydeskviewImpl(ExternalLibrary dylib) =>
      EasydeskviewImpl.raw(EasydeskviewPlatform(dylib));

  /// Only valid on web/WASM platforms.
  factory EasydeskviewImpl.wasm(FutureOr<WasmModule> module) =>
      EasydeskviewImpl(module as ExternalLibrary);
  EasydeskviewImpl.raw(this._platform);
  Stream<String> startGlobalEventStream(
      {required String appType, dynamic hint}) {
...
class EasydeskviewPlatform extends FlutterRustBridgeBase<EasydeskviewWire> {
  EasydeskviewPlatform(ffi.DynamicLibrary dylib)
      : super(EasydeskviewWire(dylib));
...
class EasydeskviewWire implements FlutterRustBridgeWireBase {
  @internal
  ...
  EasydeskviewWire(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  EasydeskviewWire.fromLookup(
