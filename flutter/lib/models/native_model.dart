...
class PlatformFFI {
  ...
  late EasydeskviewImpl _ffiBind;
  ...
  EasydeskviewImpl get ffiBind => _ffiBind;
  ...
  Future<void> init(String appType) async {
    ...
    final dylib = isAndroid
        ? DynamicLibrary.open('libeasydeskview.so')
        : isLinux
            ? DynamicLibrary.open('libeasydeskview.so')
            : isWindows
                ? DynamicLibrary.open('libeasydeskview.dll')
                :
                ...
                //
                // isMacOS? DynamicLibrary.open("liblibeasydeskview.dylib") :
    ...
    try {
      ...
      _ffiBind = EasydeskviewImpl(dylib);
  ...
  void _startListenEvent(EasydeskviewImpl rustdeskImpl) {
    final appType =
